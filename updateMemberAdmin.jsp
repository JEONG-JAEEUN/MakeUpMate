...
%>
	<div class="container">
      <form id="joinForm" name="upMemA" method="post" action="updateMemberAmdinResult.jsp">
        <div id="joinInner">
        ...
        <!--  <div class="flexPass2">
		  ...
		  <div id="btnFlex">
		  <div id="reset"><a href="manager_index.jsp" style="display: flex; align-items: center; justify-content: center; width: 100%; height: 100%; text-decoration: none;">취소</a></div>
...
%>
<script language="javascript" src="./JS/update2.js"></script>
</body>
</html>