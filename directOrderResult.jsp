...
<head>
<title>결제 완료</title>
<script language="javascript" src="./JS/directOrderResult.js">
</script>
<style>
    #container {
      width: 1280px;
...
<%
	...
	quantitypstmt.setString(2, item_id);
